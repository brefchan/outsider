...
import (
	...
	testdata "github.com/bref/outsider/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/bref/outsider/framework/gin.handlerNameTest$", c.HandlerName())
}
